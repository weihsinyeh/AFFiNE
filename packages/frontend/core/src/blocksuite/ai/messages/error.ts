...
const PaymentRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${"You've reached the current usage cap for I²-Note AI. You can subscribe to I²-Note AI(with free 7-day-trial) to continue the AI experience!"}
    .actionText=${'Upgrade'}
...
const LoginRequiredErrorRenderer = (host?: EditorHost | null) => html`
  <ai-error-wrapper
    .text=${'You need to login to I²-Note Cloud to continue using I²-Note AI.'}
    .actionText=${'Login'}
